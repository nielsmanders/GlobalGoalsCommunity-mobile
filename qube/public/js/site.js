...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__fancyapps_fancybox__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__fancyapps_fancybox_dist_jquery_fancybox_css__ = __webpack_require__(3);
...
$(document).ready(function () {
  ...
  // Animated label
  $(document).on('focus', '.animated-label input, .animated-label textarea, .animated-label .textarea', function () {
    $(this).parent().find(".label").addClass("animated");
  });

  $(document).on('blur', '.animated-label input, .animated-label textarea, .animated-label .textarea', function () {
    if ($(this).hasClass('textarea')) {
      if ($(this).html() == '<p><br data-cke-filler="true"></p>') {
  ...
  $.fancyConfirm = function (opts) {
    ...
    $.fancybox.open({
      type: 'html',
      src: '<div class="fc-content">' + '<h3>' + opts.title + '</h3>' + '<p>' + opts.message + '</p>' + opts.form + '<div class="buttons">' + '<a data-value="0" data-fancybox-close>' + opts.noButton + '</a>' + '<button data-value="1" data-fancybox-close class="btn btn-blue">' + opts.okButton + '</button>' + '</div>' + '</div>',
      opts: {
