...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__fancyapps_fancybox__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__fancyapps_fancybox_dist_jquery_fancybox_css__ = __webpack_require__(12);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lazysizes__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lazysizes_plugins_bgset_ls_bgset__ = __webpack_require__(14);
...
$(document).ready(function () {
    ...
    if (readCookie('acceptCookie')) {
        $('.cookie-notification').addClass('display-none');
    } else {
        $('.cookie-notification').removeClass('display-none');
        $('.cookie-notification').addClass('display-block');
    }
    ...
    // setTimeout(function() {
    //     if (!readCookie('development')) {
    //         $.fancyConfirm({
    //             title: "We zijn hard aan het werk!",
    //             message: "Hey, leuk dat je er bent! Op dit moment zijn we nog volop aan de website aan het werken en het kan dus zijn dat er nog een aantal fouten op de website te vinden zijn. Als je fouten vindt kun je deze mailen naar <a class='text-highlight' href='mailto:development@globalgoalscommunity.eu'>development@globalgoalscommunity.eu</a>. <br /><br /><b>Alvast bedankt!</b><br />Development team GGC<br /><img width='200' src='public/assets/team-dev-ggc.png'/>",
    //             okButton: "Doe ik!",
    //             callback: function(value) {
    //                 if (value) {
    //                     createCookie('development', true, 1);
    //                 }
    //             }
    //         });
    //     }
    ...
    $.fancyConfirm = function (opts) {
        ...
        $.fancybox.open({
            type: 'html',
            src: '<div class="fc-content">' + '<h3>' + opts.title + '</h3>' + '<p>' + opts.message + '</p>' + '<div class="buttons">' + '<a data-value="0" data-fancybox-close>' + opts.noButton + '</a>' + '<button data-value="1" data-fancybox-close class="btn btn-primary">' + opts.okButton + '</button>' + '</div>' + '</div>',
            opts: {
    ...
    $(".accept-cookies").click(function () {
        createCookie('acceptCookie', true, 365);
        $('.cookie-notification').addClass('display-none');
    });
});
