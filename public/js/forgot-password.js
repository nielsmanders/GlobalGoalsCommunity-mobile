...
$(document).ready(function () {
    ...
    $("#forgot-password-form :input").on("keydown", function () {
    ...
    $('#forgot-password-form').on("submit", function (e) {
        ...
        if (email) {
            ...
            $.ajax({
                ...
                if (data.success) {
                    $(".forgot-password-form").addClass("display-none");
                    $(".success-notification").removeClass("display-none");
                } else {
                    $(".error-msg").html("Er bestaat nog geen account onder het opgegeven e-mail adres. Wil je nu een <a href='/register/'>account aanmaken</a>?").addClass("show");
                }
            }).fail(function (data) {
                $(".error-msg").html("Er bestaat nog geen account onder het opgegeven e-mail adres. Wil je nu een <a href='/register/'>account aanmaken</a>?").addClass("show");
            });
